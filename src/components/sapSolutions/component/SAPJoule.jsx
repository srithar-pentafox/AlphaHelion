...
const AccordionRender = ({ accData = [] }) => {
  return (
    <Accordion type="multiple" defaultValue={["item-0"]} className="flex flex-col gap-4">
...
//     contentIcon: <IconPointFilled className="text-blue-400" size={20} />,
//     content: [
//       "Talent intelligence and recruiting recommendations",
//       "Learning recommendations for employees",
//       "Compensation planning insights",
...
// function SAPJoule() {
//   const isOdd = SAP_AI_Suite.length % 2 !== 0;
//   return (
//     <ContentLayout>
