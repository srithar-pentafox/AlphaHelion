...
const sapBtpPillars = [
  ...
  },
  {
    ...
    content: [
      ...
      "Workflow Management -- Design and orchestrate multi-step business processes",
      "Robotic Process Automation (RPA) -- Automate repetitive tasks",
      "Decision Logic -- Implement business rules for automated decisions",
    ],
    section: {
      title: "Key Benefits",
      content: [
  ...
  },
  {
    ...
    cardTitles: {
      ...
      subTitle:
        "Unify, manage, and analyze data from across your enterprise to drive data-driven decisions.",
    },
    contentHeading: "Core Technologies",
    contentIcon: <IconPointFilled size={17} className="text-blue-400" />,
    content: [
      "SAP Datasphere -- Unified data fabric",
      "SAP HANA Cloud -- In-memory data processing",
      "SAP Analytics Cloud -- Analytics and planning",
      "Data Intelligence -- Data pipeline orchestration",
    ],
    section: {
      title: "Key Benefits",
      content: [
  ...
  },
  {
    ...
    cardTitles: {
      ...
      subTitle:
        "Embed intelligent capabilities into business processes with enterprise-ready AI services.",
    },
    contentHeading: "Core Technologies",
    contentIcon: <IconPointFilled size={17} className="text-blue-400" />,
    content: [
      "SAP AI Core -- Scalable AI runtime",
      "SAP AI Launchpad -- Central AI management",
      "Generative AI Hub -- Multi-LLM access",
      "SAP Business AI -- Embedded intelligence",
    ],
    section: {
      title: "Key Benefits",
      content: [
...
function SAPBTPPillars() {
  const isOdd = sapBtpPillars.length % 2 !== 0;
    ...
    <ContentLayout cardBg="bg-white">
      <section className="flex flex-col gap-15">
        ...
        <section
          ...
          "
        >
          {sapBtpPillars.map((item, index) => {
            const isLast = index === sapBtpPillars.length - 1;

            return (
              <div
                key={index}
                className={`w-full ${isOdd && isLast ? "md:col-span-2" : ""}`}
              >
                <div
                  className={`h-full ${
                ...
                >
                  <DynamicCard {...item} cardType="section" />
                </div>
              </div>
            );
          })}
